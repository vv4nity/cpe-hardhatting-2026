        ...
        <div className="absolute inset-y-0 left-9 right-0 flex items-end gap-2.5">
          {chart.points.map((p) => {
            ...
            return (
              ...
              >
                <div className="relative w-full max-w-[44px] h-full flex flex-col justify-end">
                  ...
                  <div
                    className="rounded-t-lg shadow-sm transition-all duration-300 group-hover:brightness-105"
                    style={{
